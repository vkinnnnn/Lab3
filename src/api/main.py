...
async def lifespan(app: FastAPI):
    ...
    logger.info("Starting Student Loan Document Extractor API")
    ...
    logger.info("Shutting down Student Loan Document Extractor API")


app = FastAPI(
    title="Student Loan Document Extractor API",
    description="REST API for extracting and comparing student loan document data with performance optimizations",
    version="1.0.0",
    lifespan=lifespan
)
...
async def root():
    ...
    return {
        "name": "Student Loan Document Extractor API",
        "version": "1.0.0",
        "status": "operational",
        "docs": "/docs",
        "features": [
