...
class TestBatchProcessing:
    ...
    def test_batch_processing_summary_creation(self):
        ...
        try:
            from api.batch_processor import BatchProcessingSummary
    ...
    def test_batch_processing_result_creation(self):
        ...
        try:
            from api.batch_processor import BatchProcessingResult
    ...
    def test_batch_processing_summary_add_result(self):
        ...
        try:
            from api.batch_processor import BatchProcessingSummary, BatchProcessingResult
