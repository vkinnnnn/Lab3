...
"""_OCR_ID = "c0c01b0942616db6"
LAYOUT_PARSER_ID = "41972eaa15f517f2"  # Custom Extractor for complex layouts
SERVICE_ACCOUNT_FILE = "/app/service-account-key.json"class CompleteDocumentExtractor:
    """
